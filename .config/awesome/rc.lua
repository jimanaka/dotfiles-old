...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({}, "F4", function() awful.util.spawn("playerctl play-pause", false) end),
...
ruled.client.connect_signal("request::rules", function()
  ...
  ruled.client.append_rule {
    ...
    properties = { focusable = false, border_widt = 0}
  }
end)
-- }}}
...
awful.spawn.with_shell("feh --no-fehbg --bg-fill ~/.config/pictures/alena-aenami-stardust-1k.jpg")
